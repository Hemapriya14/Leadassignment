	    ...
	    driver.findElement(By.linkText("CRM/SFA")).click();
		   ...
		   driver.findElement(By.linkText("Create Lead")).click();
		    ...
		    driver.findElement(By.id("createLeadForm_parentPartyId")).sendKeys("97654");
			  ...
			  driver.findElement(By.id("createLeadForm_annualRevenue")).sendKeys("56420");
			  driver.findElement(By.id("createLeadForm_sicCode")).sendKeys("432");
			  ...
			  driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("14/07/99");
			  ...
			  WebElement dropdown1=driver.findElement(By.id("createLeadForm_dataSourceId"));
			    ...
			    WebElement dropdown2=driver.findElement(By.id("createLeadForm_industryEnumId"));
			     ...
			     driver.findElement(By.id("createLeadForm_primaryPhoneCountryCode")).sendKeys("32");
			     ...
			     driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("venkatsuja02@gmail.com");
			     ...
			     driver.findElement(By.id("createLeadForm_generalAddress1")).sendKeys("Arcott");
			     driver.findElement(By.id("createLeadForm_generalCity")).sendKeys("Vellore");;
			     driver.findElement(By.id("createLeadForm_generalPostalCode")).sendKeys("5133");
			     driver.findElement(By.id("createLeadForm_generalPostalCodeExt")).sendKeys("5133");
			     driver.findElement(By.id("createLeadForm_generalAttnName")).sendKeys("Hema");
			     driver.findElement(By.id("createLeadForm_generalAddress2")).sendKeys("Arcot");
